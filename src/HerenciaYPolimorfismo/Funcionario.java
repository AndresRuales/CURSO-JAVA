...
public class Funcionario {
	...
	//para implemtar una clase interfaz en una clase normal, se hace con la palabra IMPLEMENTS
		...
		//LA INTERFAZ SOLO TIENE LA FIRMA DEL METODO
	
	
	//RESUMEN
		//INTERFACES --> NO TIENEN ATRIBUTOS, NO TIENEN CONSTRUCTORES
			//TODA INTERFAZ ES ABSTRACTA
			//LOS METODOS NO PUEDEN TENER IMPLEMENTACION
			//DEFINE SOLO METODOS ABSTRACTOS
